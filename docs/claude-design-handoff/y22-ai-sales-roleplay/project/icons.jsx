...
const PhoneOff = (p) => <Icon {...p}><path d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7 2 2 0 0 1 1.72 2v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.42 19.42 0 0 1-3.33-2.67"/><path d="M5 5l14 14"/><path d="M22 2 2 22"/></Icon>;
...
const Sparkles = (p) => <Icon {...p}><path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3z"/></Icon>;
...
const Beaker = (p) => <Icon {...p}><path d="M9 3h6"/><path d="M10 3v8L4 21h16l-6-10V3"/></Icon>;
...
const Volume = (p) => <Icon {...p}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></Icon>;
...
Object.assign(window, {
  Icon, ChevronDown, ChevronRight, ChevronUp, X, Phone, PhoneOff, Play, Bookmark, ArrowRight,
  Mic, Sparkles, Activity, Settings, Copy, TrendingUp, TrendingDown, Layers, Beaker, Book,
  Check, Circle, Save, Volume, Hash
});
